...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../team-breakthrough',
    '/home/ubuntu/team-breakthrough-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf team-breakthrough-temp && mkdir team-breakthrough-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r team-breakthrough-temp/* team-breakthrough/ && rm -rf team-breakthrough-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd team-breakthrough && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    .connect({
      ...
      host: '54.174.39.207',
      username: 'ubuntu',
      privateKey: 'TEAMbreakthrough.pem'
    })
    .then(function() {
    ...
    .then(function() {
      console.log('Creating `team-breakthrough-temp` folder.');
