...
const Lori = () => (
  <div className="LDiv grid">
    ...
    <div className="jumbotron text-center">
      <h1 className="LDh1">
        I am a Software Developer eager to make your life easier!
      </h1>
      <img
    ...
    <div className="skills-c">
      ...
      <div className="skills-d">
        <div className="story">
          ...
          Until I went to a Heaven Come Conference in Dallas that was put on by
          ...
          <br /> <strong>The MISSION is greater than the CODE!</strong>
        </div>
      </div>
    </div>
  </div>
